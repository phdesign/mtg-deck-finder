...
class TestDeck:
    ...
    def test_add_should_sum_counts_by_name(self):
        deck = Deck(
            [
                DeckEntry(count=1, name="Abzan Banner"),
                DeckEntry(count=3, name="Act of Treason"),
            ],
            name="sample",
        )
        other = Deck(
            [
                DeckEntry(count=2, name="Abzan Banner"),
                DeckEntry(count=2, name="Act of Treason"),
            ],
            name="sample2",
        )
    ...
    def test_add_should_not_sum_counts_from_different_editions(self):
        deck = Deck(
            [
                DeckEntry(
                    count=1, name="Abzan Banner", edition="Khans of Tarkir", number=215
                ),
                DeckEntry(
                    count=3, name="Act of Treason", edition="Khans of Tarkir", number=95
                ),
            ],
            name="sample",
        )
        other = Deck(
            [
                DeckEntry(
                    count=2, name="Abzan Banner", edition="Dominaria", number=123
                ),
                DeckEntry(
                    count=2, name="Act of Treason", edition="Khans of Tarkir", number=95
                ),
            ],
            name="sample2",
        )
